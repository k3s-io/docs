...
Upgrades performed via the installation script or using our [automated upgrades](/upgrades/automated/) feature can be tied to different release channels. The following channels are available:
