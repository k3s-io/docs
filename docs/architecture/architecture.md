...
![K3s Architecture with a Single Server](/img/k3s-architecture-single-server.png)
...
![K3s Architecture with a High-availability Server](/img/k3s-architecture-ha-server.png)
