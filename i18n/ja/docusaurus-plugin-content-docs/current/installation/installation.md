...
[プライベートレジストリの構成](images/private-registry.md)では、`registries.yaml`を使用してコンテナイメージレジストリミラーを構成する方法について説明します。

[埋め込みミラー](images/registry-mirror.md)では、埋め込み分散イメージレジストリミラーを有効にする方法を示します。
