...
[Private Registry Configuration](images/private-registry.md) covers use of `registries.yaml` to configure container image registry mirrors.

[Embedded Mirror](images/registry-mirror.md) shows how to enable the embedded distributed image registry mirror.
